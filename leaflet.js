...
var RHCoords = L.marker([39.05624,-77.126636]).addTo(map);
var HiltonCoords = L.marker([39.061266,-77.122761]).addTo(map);
/*var BlueStarCoords = L.marker([39.0440965,-77.1134442]).addTo(map);*/
var MotiCoords = L.marker([39.046623,-77.098179]).addTo(map);
var SiennaCoords = L.marker([39.0460687,-77.1014113]).addTo(map);
var JCCCoords = L.marker([39.053284, -77.125292]).addTo(map);
var MarriottCoords = L.marker([39.047339, -77.115067]).addTo(map);
var EvenCoords = L.marker([39.060010, -77.123485]).addTo(map);
var SunflowerCoords= L.marker([39.049300, -77.123083]).addTo(map);
var OhMamaCoords= L.marker([39.0583356,-77.1262014]).addTo(map);
var CanopyCoords = L.marker([39.050792, -77.116884]).addTo(map);
var CongressionalTowersCoords = L.marker([39.06200125200742, -77.13250340209653]).addTo(map);
var ArriveNorthBethesdaCoords = L.marker([39.05366186862672, -77.11897970444505]).addTo(map);
var RollinsParkApartmentsCoords = L.marker([39.0605537558711, -77.12896003186087]).addTo(map);
var TheStoriesApartmentsCoords = L.marker([39.062067413091505, -77.12838408768285]).addTo(map);
var TheResidencesAtCongressionalVillageCoords = L.marker([39.06035842560305, -77.12582544535408]).addTo(map);
var RollinsRidgeCoords = L.marker([39.05859898666559, -77.12303173102656]).addTo(map);
var MiramontCoords = L.marker([39.056202648302644, -77.12545790219093]).addTo(map);
var PerseiCoords = L.marker([39.04987682154621, -77.1167081818421]).addTo(map);
var PallasCoords = L.marker([39.049189779547476, -77.11867800219115]).addTo(map);
var HenriCoords = L.marker([39.05043506271609, -77.11748065801258]).addTo(map);
