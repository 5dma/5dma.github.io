...
var EICoords = L.marker([39.0535927, -77.1323148], {icon: eiIcon}).addTo(map);
var RHCoords = L.marker([39.0561925, -77.1297025], {icon: otherIcon}).addTo(map);
var JCCCoords = L.marker([39.0534425, -77.1272068], {icon: otherIcon}).addTo(map);
var HiltonCoords = L.marker([39.0612469, -77.1247437], {icon: hotelIcon}).addTo(map);
var MarriottCoords = L.marker([38.98719, -77.0984983], {icon: hotelIcon}).addTo(map);
var EvenCoords = L.marker([39.0599831, -77.1260973], {icon: hotelIcon}).addTo(map);
var CanopyCoords = L.marker([39.0509772, -77.1185171], {icon: hotelIcon}).addTo(map);
/*var BlueStarCoords = L.marker([39.0440965, -77.1134442]).addTo(map);*/
var MotiCoords = L.marker([39.0462822, -77.1020042], {icon: superIcon}).addTo(map);
var SiennaCoords = L.marker([39.0460728, -77.1018029], {icon: restaurantIcon}).addTo(map);
var GoldbergCoords = L.marker([39.0461722, -77.1035264], {icon: restaurantIcon}).addTo(map);
var AlHaeshCoords = L.marker([39.0462486, -77.1021236], {icon: restaurantIcon}).addTo(map);
var SunflowerCoords= L.marker([39.0495339, -77.1256747], {icon: restaurantIcon}).addTo(map);
var OhMamaCoords= L.marker([39.0583282, -77.1287712], {icon: restaurantIcon}).addTo(map);
var CongressionalTowersCoords = L.marker([39.0617733, -77.1351423], {icon: apartmentIcon}).addTo(map);
var ArriveNorthBethesdaCoords = L.marker([39.053557, -77.1216273], {icon: apartmentIcon}).addTo(map);
var RollinsParkApartmentsCoords = L.marker([39.0603746, -77.1315296], {icon: apartmentIcon}).addTo(map);
var TheStoriesApartmentsCoords = L.marker([39.0619196, -77.1308684], {icon: apartmentIcon}).addTo(map);
var TheResidencesAtCongressionalVillageCoords = L.marker([39.0602955, -77.1282794], {icon: apartmentIcon}).addTo(map);
var RollinsRidgeCoords = L.marker([39.0586281, -77.1256013], {icon: apartmentIcon}).addTo(map);
var MiramontCoords = L.marker([39.0562151, -77.1280382], {icon: apartmentIcon}).addTo(map);
var PallasCoords = L.marker([39.0493432,-77.1213884], {icon: apartmentIcon}).addTo(map);
var HenriCoords = L.marker([39.0503392, -77.1201146], {icon: apartmentIcon}).addTo(map);
var PerseiCoords = L.marker([39.0498803, -77.1193082], {icon: apartmentIcon}).addTo(map);
var NorthBethesdaCoords = L.marker([39.0475727, -77.1152301], {icon: metroIcon}).addTo(map);
var TwinbrookCoords = L.marker([39.0623989, -77.1257284], {icon: metroIcon}).addTo(map);
var GrosvenorStrathmoreCoords = L.marker([39.0290907, -77.1063865], {icon: metroIcon}).addTo(map);
